...
public class JobController {
    ...
    @GetMapping("/list")
    public Result<PageVO<ListJobVO>> listJob(@Valid @ModelAttribute ListJobRequest listJobRequest) {
        return Result.success(this.jobService.getPageList(listJobRequest));
    }
}
